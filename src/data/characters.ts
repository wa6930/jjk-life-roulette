...
export const CHARACTER_POOL: Omit<Character, 'alive' | 'affinity' | 'appearedInPhase'>[] = [
  ...
  { id: 'megumi', name: '伏黑惠', title: '十种影法术使用者', relation: 'friend', romanceable: true, preferGender: 'female' },
  { id: 'nobara', name: '钉崎野蔷薇', title: '刍灵咒法使用者', relation: 'friend', romanceable: true, preferGender: 'male' },
  { id: 'yuji', name: '虎杖悠仁', title: '宿傩的容器', relation: 'friend', romanceable: true, preferGender: 'female' },
  { id: 'nanami', name: '七海建人', title: '一级咒术师', relation: 'mentor' },
  { id: 'todo', name: '东堂葵', title: '不义游戏使用者', relation: 'rival', romanceable: true, preferGender: 'female' },
  { id: 'maki', name: '禅院真希', title: '咒具使い', relation: 'friend', romanceable: true, preferGender: 'male' },
  ...
  { id: 'yuta', name: '乙骨忧太', title: '特级咒术师', relation: 'rival', romanceable: true, preferGender: 'female' },
  { id: 'riko', name: '天内理子', title: '星浆体', relation: 'friend' },
  { id: 'toji', name: '伏黑甚尔', title: '术师杀手', relation: 'enemy' },
  { id: 'junpei', name: '吉野顺平', title: '温柔的少年', relation: 'friend' },
  { id: 'tsumiki', name: '伏黑津美菜', title: '惠的姐姐', relation: 'friend' },
]
/** 根据出身获取初始角色 */
export function getInitialCharacters(originId: string): string[] {
  const map: Record<string, string[]> = {
    ...
    gojo_branch: ['gojo', 'yaga', 'yuta'],
    zenin_outcast: ['maki', 'zenin', 'megumi'],
    cursed_womb: ['choso', 'mahito', 'kenjaku'],
    star_plasma: ['riko', 'gojo', 'toji'],
  }
...
export const PHASE_CHARACTER_POOL: Record<string, string[]> = {
  ...
  school: ['todo', 'maki', 'toge', 'panda', 'yuta', 'kamo', 'mei', 'uta', 'riko', 'junpei', 'tsumiki'],
